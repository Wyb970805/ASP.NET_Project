<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="_2222222222.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="gvComment" runat="server" AutoGenerateColumns="False" BorderStyle="None" GridLines="None" ShowHeader="False" Width="100%" DataKeyNames="commentID" OnRowDataBound="OnRowDataBound">
                <Columns>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div id='divReply<%#Eval("commentID") %>' style="display: none; margin-top: 5px;">
                                                        ...
                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please reply on this comment" CssClass="error" ControlToValidate="txtReply" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                                                        <br />
                                                        <asp:Button ID="btnReply" runat="server" class="btn btn-sm btn-dark" Text="Reply" OnClick="btnReply_Click" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <asp:GridView ID="gvReply" BorderStyle="None" GridLines="None" runat="server" AutoGenerateColumns="False" ShowHeader="False">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="UserID">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUserID" runat="server" Font-Italic="True" Font-Size="Large" Font-Bold="true" ForeColor="#ff0066" Text='<%# Bind("userID") %>'></asp:Label>
                                                                    <br />
                                                                    <asp:Label ID="lblReplyDate" runat="server" Text='<%# Bind("replyDate") %>'></asp:Label>
                                                                    <br />
                                                                    <asp:Label ID="lblRelyContent" Font-Size="Large" runat="server" Text='<%# Bind("content") %>'></asp:Label>
                                                                    <hr />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
